...
class user:
    ...
    def topLogin(self):
        ...
        total_days = data["cache"]["updated"]["userLogin"][0][
            "totalLoginCount"
        ]
        ...
        if "seqLoginBonus" in data["response"][0]["success"]:
            ...
            if "campaignbonus" in data["response"][0]["success"]:
                bonus_name = data["response"][0]["success"]["campaignbonus"][
                    0
                ]["name"]
        ...
        for response in responses:
            ...
            if nid == "purchase":
                if (
                    ...
                    main.logger.info(
                        f"{purchaseNum}x {purchaseName} purchased!"
                    )
    ...
    def drawFP(self):
        ...
        if main.fate_region == "NA":
            ...
            main.logger.info("Friend Point Gacha Sub Id " + gachaSubId)
        else:
